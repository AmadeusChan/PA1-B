 ...
 * Generated at: Sat Nov 11 16:29:04 CST 2017
        ...
        switch (nonTerminal) {
            ...
            case CaseExprList: {
                switch (lookahead) {
                    case LITERAL:
                    case NULL:
                        return new Pair<>(53, Arrays.asList(Constant, Integer.valueOf(':'), Expr, Integer.valueOf(';'), CaseExprList));
                    case DEFAULT:
            ...
            case ClassDef: {
                switch (lookahead) {
                    case CLASS:
                        return new Pair<>(55, Arrays.asList(CLASS, IDENTIFIER, ExtendsClause, Integer.valueOf('{'), FieldList, Integer.valueOf('}')));
                    default: return null;
                }
            }
            //# line 801
            case ReturnStmt: {
                switch (lookahead) {
                    case RETURN:
                        return new Pair<>(56, Arrays.asList(RETURN, ReturnExpr));
                    default: return null;
                }
            }
            //# line 749
            case ExprList: {
                switch (lookahead) {
                    ...
                    case '#':
                    case READ_INTEGER:
                        return new Pair<>(57, Arrays.asList(Expr, SubExprList));
                    default: return null;
                }
            }
            //# line 194
            case StmtBlock: {
                switch (lookahead) {
                    case '{':
                        return new Pair<>(58, Arrays.asList(Integer.valueOf('{'), StmtList, Integer.valueOf('}')));
                    default: return null;
                }
            }
            //# line 155
            case FunctionField: {
                switch (lookahead) {
                    case '(':
                        return new Pair<>(59, Arrays.asList(Integer.valueOf('('), Formals, Integer.valueOf(')'), StmtBlock));
                    case ';':
            ...
            case AfterIdentExpr: {
                switch (lookahead) {
                    case '(':
                        return new Pair<>(61, Arrays.asList(Integer.valueOf('('), Actuals, Integer.valueOf(')')));
                    case '/':
                    case LESS_EQUAL:
                    case ']':
                    case GREATER_EQUAL:
            ...
            case Type: {
                switch (lookahead) {
                    ...
                    case STRING:
                    case BOOL:
                        return new Pair<>(65, Arrays.asList(SimpleType, ArrayType));
                    default: return null;
                }
            }
            //# line 523
            case Expr5: {
                switch (lookahead) {
                    ...
                    case '#':
                    case READ_INTEGER:
                        return new Pair<>(66, Arrays.asList(Expr6, ExprT5));
                    default: return null;
                }
            }
            //# line 691
            case AfterNewExpr: {
                switch (lookahead) {
                    case IDENTIFIER:
                        return new Pair<>(67, Arrays.asList(IDENTIFIER, Integer.valueOf('('), Integer.valueOf(')')));
                    case COMPLEX:
                    case VOID:
                    case CLASS:
                    case INT:
                    case STRING:
                    case BOOL:
                        return new Pair<>(68, Arrays.asList(SimpleType, Integer.valueOf('['), AfterSimpleTypeExpr));
                    default: return null;
                }
            }
            //# line 265
            case Assignment: {
                switch (lookahead) {
                    case '=':
                        return new Pair<>(69, Arrays.asList(Integer.valueOf('='), Expr));
                    case ';':
                    case ')':
                        return new Pair<>(119, Arrays.asList());
                    default: return null;
            ...
            case ExtendsClause: {
                switch (lookahead) {
                    case EXTENDS:
                        return new Pair<>(71, Arrays.asList(EXTENDS, IDENTIFIER));
                    case '{':
                        return new Pair<>(119, Arrays.asList());
                    default: return null;
                }
            ...
            case Oper5: {
                switch (lookahead) {
                    case '+':
                        return new Pair<>(73, Arrays.asList(Integer.valueOf('+')));
                    case '-':
            ...
            case ArrayType: {
                switch (lookahead) {
                    case '[':
                        return new Pair<>(75, Arrays.asList(Integer.valueOf('['), Integer.valueOf(']'), ArrayType));
                    case IDENTIFIER:
            ...
            case Expr3: {
                switch (lookahead) {
                    ...
                    case '#':
                    case READ_INTEGER:
                        return new Pair<>(77, Arrays.asList(Expr4, ExprT3));
                    default: return null;
                }
            }
            //# line 739
            case Actuals: {
                switch (lookahead) {
                    ...
                    case '#':
                    case READ_INTEGER:
                        return new Pair<>(78, Arrays.asList(ExprList));
                    case ')':
            ...
            case Variable: {
                switch (lookahead) {
                    ...
                    case STRING:
                    case BOOL:
                        return new Pair<>(80, Arrays.asList(Type, IDENTIFIER));
                    default: return null;
                }
            }
            //# line 477
            case ExprT3: {
                switch (lookahead) {
                    case EQUAL:
                    case NOT_EQUAL:
                        return new Pair<>(81, Arrays.asList(Oper3, Expr4, ExprT3));
                    case ']':
                    case ')':
                    case ',':
                    case '=':
            ...
            case Stmt: {
                switch (lookahead) {
                    ...
                    case STRING:
                    case BOOL:
                        return new Pair<>(83, Arrays.asList(VariableDef));
                    case CASE:
                    case '!':
                    case '-':
                    case READ_LINE:
                    ...
                    case '#':
                    case READ_INTEGER:
                        return new Pair<>(84, Arrays.asList(SimpleStmt, Integer.valueOf(';')));
                    case IF:
                        return new Pair<>(85, Arrays.asList(IfStmt));
                    case WHILE:
                        return new Pair<>(86, Arrays.asList(WhileStmt));
                    case FOR:
                        return new Pair<>(87, Arrays.asList(ForStmt));
                    case RETURN:
                        return new Pair<>(88, Arrays.asList(ReturnStmt, Integer.valueOf(';')));
                    case PRINT:
                        return new Pair<>(89, Arrays.asList(PrintStmt, Integer.valueOf(';')));
                    case PRINTCOMP:
                        return new Pair<>(90, Arrays.asList(PrintCompStmt, Integer.valueOf(';')));
                    case BREAK:
            ...
            case SimpleType: {
                switch (lookahead) {
                    ...
                    case COMPLEX:
                        return new Pair<>(100, Arrays.asList(COMPLEX));
                    default: return null;
                }
            }
            //# line 770
            ...
            case DefaultExpr: {
                switch (lookahead) {
                    case DEFAULT:
                        return new Pair<>(115, Arrays.asList(DEFAULT, Integer.valueOf(':'), Expr, Integer.valueOf(';')));
                    default: return null;
                }
            }
            //# line 581
            case Expr7: {
                switch (lookahead) {
                    ...
                    case '$':
                    case '#':
                        return new Pair<>(116, Arrays.asList(Oper7, Expr7));
                    case CASE:
                    case READ_LINE:
                    case NULL:
                    case IDENTIFIER:
